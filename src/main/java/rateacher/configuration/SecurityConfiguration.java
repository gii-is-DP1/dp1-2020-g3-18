...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/reports/**").hasAnyAuthority("teacher")
				.antMatchers("/teachers/{teacherId}/studentsRated").hasAnyAuthority("admin")
				.antMatchers("/teachers/{teacherId}/newPersonalExperience").hasAnyAuthority("admin")
				.antMatchers("/teachers/{subjectId}/subjectsTeached").permitAll()
				...
				.antMatchers("/personalExperience/{personalExperienceId}/newResearchExperience").hasAnyAuthority("admin")
				.antMatchers("/personalExperience/{personalExperienceId}/newTeachingExperience").hasAnyAuthority("admin")
				.antMatchers("/personalExperience/{personalExperienceId}/newProfessionalExperience").hasAnyAuthority("admin")
				.antMatchers("/personalExperience/{personalExperienceId}/newExternalEvaluation").hasAnyAuthority("admin")
				.anyRequest().denyAll()
				.and()
				 	.formLogin()
				 	/*.loginPage("/login")*/
